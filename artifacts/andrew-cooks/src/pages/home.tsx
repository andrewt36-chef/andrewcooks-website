...
export default function Home() {
  ...
  const services = [
    ...
    },
    {
      ...
      img: braisedBeef,
      alt: "Braised beef in copper pots — weekly chef service",
    },
    {
      title: "House Parties",
      desc: "Residential cooking for extended stays, weekend house parties, and holiday homes across the UK.",
      img: souffle,
      alt: "Chocolate soufflé — house party dessert by Andrew Taylor",
    },
  ];

  const miniGallery = [
    { img: canapes, alt: "Elegant canapés on skeleton leaves" },
    { img: truffleEggs, alt: "Devilled eggs with black truffle" },
    { img: heirloomTomatoes, alt: "Seasonal heirloom tomatoes" },
    { img: truffles, alt: "Fresh black truffles" },
    { img: heroImg, alt: "Red mullet with langoustine" },
  ];
    ...
    <>
      ...
      <section className="py-24 bg-card border-y border-border/50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            ...
            <Link
              href="/services"
              className="text-sm tracking-widest uppercase hover:text-primary transition-colors border-b border-foreground pb-1"
          ...
          >
            {services.map((service, i) => (
              <motion.div key={i} variants={fadeInUp} className="group cursor-pointer">
                ...
                <Link
                  href="/services"
                  className="text-xs tracking-widest uppercase text-primary flex items-center gap-2"
                >
      ...
      <section className="py-32 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="font-serif text-3xl md:text-5xl max-w-4xl mx-auto leading-snug mb-8">
            "Andrew created an absolutely unforgettable evening for my husband's 50th
            birthday. The food was spectacular, the presentation flawless, and he left our
            kitchen spotless. Having a Michelin-quality meal in our own dining room was
            magical."
          </h2>
      ...
      <section className="py-4 flex overflow-hidden gap-4">
        {miniGallery.map((item, i) => (
          <div key={i} className="w-64 h-64 md:w-80 md:h-80 shrink-0">
            <img
              src={item.img}
              alt={item.alt}
              loading="lazy"
